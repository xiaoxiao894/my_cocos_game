      ...
      _export("EnemyController", EnemyController = class EnemyController {
        ...
        init() {
          if ((_crd && App === void 0 ? (_reportPossibleCrUseOfApp({
            ...
            (_crd && App === void 0 ? (_reportPossibleCrUseOfApp({
              ...
              let enemy = item.getComponent(_crd && EnemySpider === void 0 ? (_reportPossibleCrUseOfEnemySpider({
                error: Error()
        ...
        continueGame() {
          ...
          for (let key in this.enemInitList) {
            ...
            let enemySpider = prefab.getComponent(_crd && EnemySpider === void 0 ? (_reportPossibleCrUseOfEnemySpider({
              error: Error()
        ...
        realCreatEnemy(pos) {
          ...
          //let scaleT = 1.8
          // 提取公共逻辑，减少重复代码
          let prefabName = (_crd && GlobeVariable === void 0 ? (_reportPossibleCrUseOfGlobeVariable({
            error: Error()
        ...
        update(dt) {
          ...
          for (let index = 0; index < this.enemyRvoList.length; index++) {
            ...
            const enemy = this.enemyRvoList[index];
            enemy == null || (_enemy$getComponent2 = enemy.getComponent(_crd && EnemySpider === void 0 ? (_reportPossibleCrUseOfEnemySpider({
              error: Error()
