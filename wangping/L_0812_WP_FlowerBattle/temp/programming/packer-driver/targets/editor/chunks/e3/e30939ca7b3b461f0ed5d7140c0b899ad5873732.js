    ...
    execute: function () {
      ...
      _export("GuideManager", GuideManager = (_dec = ccclass('GuideManager'), _dec(_class = (_class2 = class GuideManager {
        ...
        continueGame() {
          ...
          let arrow3d = (_crd && App === void 0 ? (_reportPossibleCrUseOfApp({
            error: Error()
          }), App) : App).guidArrow3D;
        ...
        checkRange() {
          ...
          let minCoin = null;
          let coinList = (_crd && App === void 0 ? (_reportPossibleCrUseOfApp({
            error: Error()
          }), App) : App).sceneNode.coinParent.children;

          for (let i = 0; i < coinList.length; i++) {
            const coin = coinList[i]; // 跳过已销毁的节点
            ...
            let selfPos = coin.worldPosition.clone(); // // 计算两点到世界原点的距离
            ...
            const forward = coin.forward; // 计算目标相对于自身的向量
            ...
            const playerPos = (_crd && App === void 0 ? (_reportPossibleCrUseOfApp({
              error: Error()
            }), App) : App).playerController.getPlayer().node.worldPosition.clone();
            const distance = enemyPos.subtract(playerPos).length(); // 记录最近的敌人
        ...
        update(dt) {
          ...
          const currentStep = this.guideStepJson[this.guideCurStep]; // 提取箭头控制通用方法
          ...
          switch (this.guidePhase) {
            ...
            case 2:
              ...
              const lockCoin = (_crd && GlobeVariable === void 0 ? (_reportPossibleCrUseOfGlobeVariable({
                error: Error()
            ...
            case 4:
              ...
              const lockCoin1 = (_crd && GlobeVariable === void 0 ? (_reportPossibleCrUseOfGlobeVariable({
                error: Error()
              ...
              const lockCoin2 = (_crd && GlobeVariable === void 0 ? (_reportPossibleCrUseOfGlobeVariable({
                error: Error()
            ...
            case 5:
              ...
              const lockCoin22 = (_crd && GlobeVariable === void 0 ? (_reportPossibleCrUseOfGlobeVariable({
                error: Error()
              ...
              const lockCoin3 = (_crd && GlobeVariable === void 0 ? (_reportPossibleCrUseOfGlobeVariable({
                error: Error()
              ...
              const lockCoin11 = (_crd && GlobeVariable === void 0 ? (_reportPossibleCrUseOfGlobeVariable({
                error: Error()
