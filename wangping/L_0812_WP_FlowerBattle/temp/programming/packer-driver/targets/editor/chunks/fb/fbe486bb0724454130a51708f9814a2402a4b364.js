  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", GoldMineController = class GoldMineController {
        ...
        getNextPosWithLength(addNum = 0) {
          let count = addNum + this._coinNum;
          let pos = new Vec3(0, 0, 0); //本层数量
        ...
        removeCoin() {
          if (this._coinNum > 0) {
            let coinNodes = (_crd && App === void 0 ? (_reportPossibleCrUseOfApp({
              error: Error()
            ...
            let coinItem = coinNodes[coinNodes.length - 1];
            this._coinNum--;
