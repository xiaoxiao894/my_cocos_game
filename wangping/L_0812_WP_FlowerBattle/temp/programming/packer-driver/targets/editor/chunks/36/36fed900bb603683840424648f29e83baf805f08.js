    ...
    execute: function () {
      ...
      _export("PalingAttack", PalingAttack = (_dec = ccclass('PalingAttack'), _dec(_class = (_class2 = class PalingAttack {
        ...
        setPaling(level = 1) {
          ...
          if (level == 1) {
            const attackPalingLevel_1 = (_crd && App === void 0 ? (_reportPossibleCrUseOfApp({
              error: Error()
            ...
            const attackPalingLevel_2 = (_crd && App === void 0 ? (_reportPossibleCrUseOfApp({
              error: Error()
            ...
            const attackPalingLevel_3 = (_crd && App === void 0 ? (_reportPossibleCrUseOfApp({
              error: Error()
          ...
          for (const key in this.attackPaling) {
            if (this.attackPaling.hasOwnProperty(key)) {
              ...
              if (paling.curNum < paling.maxNum) {
                let disSqr = Vec3.squaredDistance(paling.node.getWorldPosition(), pos);
        ...
        updateBounding() {
          let palings = (_crd && App === void 0 ? (_reportPossibleCrUseOfApp({
            error: Error()
