System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "3b3d2JI73JJboAuAX4nEXJe", "RVOObstacles", undefined);
      ...
      _export("default", RVOObstacles = class RVOObstacles {
        static addOneObstacle(obstacle) {
          let collider = obstacle.getComponent(Collider);
          ...
          if (collider instanceof BoxCollider) {
            ...
            const corners = [new Vec3(-halfExtents.x, 0, -halfExtents.z), new Vec3(halfExtents.x, 0, -halfExtents.z), new Vec3(halfExtents.x, 0, halfExtents.z), new Vec3(-halfExtents.x, 0, halfExtents.z), new Vec3(-halfExtents.x, 0, -halfExtents.z) // 闭合多边形
            ]; // 转换到世界空间
...
//# sourceMappingURL=8afebec34f7297fc301a9ed82f0262e562ad13bc.js.map