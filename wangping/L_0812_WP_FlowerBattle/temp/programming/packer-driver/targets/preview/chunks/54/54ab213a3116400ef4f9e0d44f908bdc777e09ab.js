      ...
      _export("App", App = (_dec = ccclass('App'), _dec2 = property(Node), _dec(_class = (_class2 = (_class3 = class App extends Component {
        ...
        onLoad() {
          ...
          return _asyncToGenerator(function* () {
            ...
            App.sceneNode = _this.node.getComponent(_crd && SceneNode === void 0 ? (_reportPossibleCrUseOfSceneNode({
              error: Error()
            }), SceneNode) : SceneNode);
            App.mapShowController = _this.root.getComponent(_crd && MapShowController === void 0 ? (_reportPossibleCrUseOfMapShowController({
              error: Error()
            ...
            yield App.dataManager.init();
            yield _this.initRes(); // App.soundManager = SoundManager.Instance;
            ...
            _this.gameManager = new (_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
              error: Error()
            }), GameManager) : GameManager)();
            App.gameManager = _this.gameManager;

            _this.gameManager.startGame();
          })();
        }
        /**应该放在加载进度中  没有进度在次调用 */
        ...
        initRes() {
          return _asyncToGenerator(function* () {
            // //创建敌人
            var prefab = yield App.resManager.loadPrefab((_crd && GlobeVariable === void 0 ? (_reportPossibleCrUseOfGlobeVariable({
              error: Error()
            ...
            var prefabL = yield App.resManager.loadPrefab((_crd && GlobeVariable === void 0 ? (_reportPossibleCrUseOfGlobeVariable({
              error: Error()
            ...
            var prefabBlood = yield App.resManager.loadPrefab((_crd && GlobeVariable === void 0 ? (_reportPossibleCrUseOfGlobeVariable({
              error: Error()
            ...
            var fireArrow = yield App.resManager.loadPrefab((_crd && GlobeVariable === void 0 ? (_reportPossibleCrUseOfGlobeVariable({
              error: Error()
            ...
            var turret = yield App.resManager.loadPrefab((_crd && GlobeVariable === void 0 ? (_reportPossibleCrUseOfGlobeVariable({
              error: Error()
            ...
            var beetle = yield App.resManager.loadPrefab((_crd && GlobeVariable === void 0 ? (_reportPossibleCrUseOfGlobeVariable({
              error: Error()
            ...
            var prefabCoin = yield App.resManager.loadPrefab((_crd && GlobeVariable === void 0 ? (_reportPossibleCrUseOfGlobeVariable({
              error: Error()
            ...
            var prefabArrow3D = yield App.resManager.loadPrefab((_crd && GlobeVariable === void 0 ? (_reportPossibleCrUseOfGlobeVariable({
              error: Error()
            }), GlobeVariable) : GlobeVariable).prefabPath.Guid_Arrow3D);
            App.guidArrow3D = instantiate(prefabArrow3D); //箭头路径

            var prefabArrowPath = yield App.resManager.loadPrefab((_crd && GlobeVariable === void 0 ? (_reportPossibleCrUseOfGlobeVariable({
              error: Error()
            ...
            var prefabFlowerTxPath = yield App.resManager.loadPrefab((_crd && GlobeVariable === void 0 ? (_reportPossibleCrUseOfGlobeVariable({
              error: Error()
            ...
            var prefabTurretTxPath = yield App.resManager.loadPrefab((_crd && GlobeVariable === void 0 ? (_reportPossibleCrUseOfGlobeVariable({
              error: Error()
            ...
            var prefabTurretBombTxPath = yield App.resManager.loadPrefab((_crd && GlobeVariable === void 0 ? (_reportPossibleCrUseOfGlobeVariable({
              error: Error()
            ...
            var prefabArrowTxPath = yield App.resManager.loadPrefab((_crd && GlobeVariable === void 0 ? (_reportPossibleCrUseOfGlobeVariable({
              error: Error()
            ...
            var prefabBeetleCollideTxPath = yield App.resManager.loadPrefab((_crd && GlobeVariable === void 0 ? (_reportPossibleCrUseOfGlobeVariable({
              error: Error()
