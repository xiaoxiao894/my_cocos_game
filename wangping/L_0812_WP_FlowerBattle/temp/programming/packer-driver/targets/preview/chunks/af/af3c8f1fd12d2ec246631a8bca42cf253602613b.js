System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "1ba87vjRK5FF6HahnOM6VB+", "ResourceManager", undefined);
      ...
      _export("ResourceManager", ResourceManager = class ResourceManager {
        ...
        load(path, type, onProgress) {
          // 检查缓存
          var cachedAsset = this._resourceCache.get(path);
          ...
          var existingTask = this._loadingTasks.get(path);
        ...
        loadAudioDir(path, onProgress) {
          // 创建新的加载任务
          var loadPromise = new Promise((resolve, reject) => {
            resources.loadDir(path, AudioClip, onProgress, (err, asset) => {
              this._loadingTasks.delete(path);
        ...
        loadPrefab(path, onProgress) {
          ...
          return _asyncToGenerator(function* () {
            return yield _this.load(path, Prefab, onProgress);
          })();
        } //使用示例
        // 加载场景时显示进度
        ...
        loadMultiple(paths, type, onProgress) {
          var promises = paths.map(path => this.load(path, type, onProgress));
        ...
        release(path) {
          var asset = this._resourceCache.get(path);
...
//# sourceMappingURL=af3c8f1fd12d2ec246631a8bca42cf253602613b.js.map