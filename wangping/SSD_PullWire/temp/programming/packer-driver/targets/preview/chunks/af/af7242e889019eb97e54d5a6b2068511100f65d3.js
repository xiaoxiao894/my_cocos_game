    ...
    execute: function () {
      ...
      _export("MapBeast", MapBeast = (_dec = ccclass('MapBeast'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Prefab), _dec5 = property(Prefab), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(_crd && CloudParticleEffect === void 0 ? (_reportPossibleCrUseOfCloudParticleEffect({
        ...
        beastStartCallBack() {
          ...
          var anim = this.palingNode.getComponent(Animation);
          anim.play();
          anim.once(Animation.EventType.FINISHED, () => {});
          this.scheduleOnce(() => {
            //升级粒子特效
            this.beastBack.active = true;
            var animParticle = this.beastBack.getComponent(Animation);
            animParticle.play();
            ...
            var animParticle1 = this.beastBackPaticle.getComponent(Animation);
            this.scheduleOnce(() => {
              animParticle1.play();
            }, 0.06);
          ...
          this.scheduleOnce(() => {
            var siblings = this.electricPalingParent.children;
            ...
            var _loop = function _loop() {
              ...
              _this.scheduleOnce(() => {
                var effectNode = sibling.getChildByName("TX_dianliuWQ");

                if (effectNode) {
                  effectNode.active = true;
                  var animation = effectNode.getComponent(Animation);
        ...
        beastRandom() {
          ...
          var random = Math.floor(Math.random() * 5) + 1; // 获取对应的动物配置

          var beasts = beastPatterns[random - 1]; // 生成动物
        ...
        spawnBear(pos, enemyDie) {
          // 从对象池获取熊敌人节点
          var bear = (_crd && poolManager === void 0 ? (_reportPossibleCrUseOfpoolManager({
            error: Error()
        ...
        spawnDog(pos, enemyDie) {
          // 从对象池获取狗敌人节点
          var dog = (_crd && poolManager === void 0 ? (_reportPossibleCrUseOfpoolManager({
            error: Error()
        ...
        spawnElephant(pos, enemyDie) {
          // 从对象池获取大象敌人节点
          var elephant = (_crd && poolManager === void 0 ? (_reportPossibleCrUseOfpoolManager({
            error: Error()
