    ...
    execute: function () {
      ...
      _export("EnemyBase", EnemyBase = (_dec = ccclass('EnemyBase'), _dec2 = property(SkeletalAnimation), _dec3 = property(Node), _dec4 = property(Node), _dec(_class = (_class2 = class EnemyBase extends Component {
        ...
        onTriggerStay(event) {
          ...
          var otherCollider = event.otherCollider; //console.log(otherCollider)
        ...
        update(deltaTime) {
          ...
          var posz = this.node.position.z - deltaTime * 2;
        ...
        playAnimation(name, loop, onFinished) {
          if (loop === void 0) {
            loop = false;
          }
          ...
          var state = this.skeletalAnim.getState(name);
