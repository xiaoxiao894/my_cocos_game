System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Camera, Component, Quat, v3, Vec3, tween, CCInteger, DataManager, EventManager, EventName, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, tempPos, CameraMain;
      ...
      _export("CameraMain", CameraMain = (_dec = ccclass('CameraMain'), _dec2 = property(Camera), _dec3 = property(CCInteger), _dec4 = property(CCInteger), _dec(_class = (_class2 = class CameraMain extends Component {
        ...
        start() {
          (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
            error: Error()
          }), DataManager) : DataManager).Instance.mainCamera = this; // 记录初始位置
        ...
        onEnable() {
          (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
            ...
            error: Error()
          }), EventName) : EventName).GameOver, this.moveCenterAndScale, this);
        }
        ...
        moveToCenter() {// this.scheduleOnce(this.realMove, this.delayTime);
        }

        realMove() {
          var distence = Vec3.distance(this.node.worldPosition, this.initialPos);
          var t = this.speed * distence;
        ...
        moveCenterAndScale() {
          this.scheduleOnce(() => {
            var orgHeight = this.camera.orthoHeight;
...
//# sourceMappingURL=f3aab412c973d81818334bbce8f33b513cd1b428.js.map