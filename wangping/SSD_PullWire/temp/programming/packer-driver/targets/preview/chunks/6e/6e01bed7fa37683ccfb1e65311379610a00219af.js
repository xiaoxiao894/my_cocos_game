  ...
  return {
    ...
    execute: function () {
      ...
      _export("MapFarmland", MapFarmland = (_dec = ccclass('MapFarmland'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(Node), _dec13 = property(Animation), _dec14 = property(_crd && CloudParticleEffect === void 0 ? (_reportPossibleCrUseOfCloudParticleEffect({
        ...
        start() {
          var animState = this.palingAnimation.getState(this.palingAnimation.defaultClip.name);
        ...
        _cacheFruitScripts() {
          ...
          this.fruitParent.children.forEach(child => {
            var fruitNode = child.getChildByName("fruitNode");

            if (fruitNode) {
              var script = fruitNode.getComponent(_crd && FruitScript === void 0 ? (_reportPossibleCrUseOfFruitScript({
                error: Error()
        ...
        palingEffctTo() {
          ...
          return _asyncToGenerator(function* () {
            _this._palingAnimations.right.startMoveDown();

            yield Promise.all([_this._palingAnimations.up.startAnimation(), _this._palingAnimations.down.startAnimation()]);
          })();
        }
        ...
        palingEffctCallBack() {
          ...
          return _asyncToGenerator(function* () {
            ...
            _this2.palingAnimation.play();

            _this2.scheduleOnce(() => {
              _this2.allEffect();
            }, 0.48);

            _this2.palingAnimation.once(Animation.EventType.FINISHED, () => {}, _this2);
        ...
        fruitRedCallBack() {
          ...
          var randomIndex = Math.floor(Math.random() * this._fruitScripts.length); // const fruitScript = greenScripts[randomIndex];
          ...
          var coinNode = this._fruitScripts[randomIndex].node.parent.getChildByName("coinNode");
        ...
        _playCoinEffect(node, coinNum) {
          if (!node) return;
          var effect = node.getComponent(_crd && coinEffect === void 0 ? (_reportPossibleCrUseOfcoinEffect({
            error: Error()
