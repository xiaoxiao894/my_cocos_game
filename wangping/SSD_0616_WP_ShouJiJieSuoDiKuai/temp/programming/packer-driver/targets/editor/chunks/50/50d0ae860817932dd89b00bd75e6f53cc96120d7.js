    ...
    execute: function () {
      ...
      _export("enemyCharacter", enemyCharacter = (_dec = ccclass('enemyCharacter'), _dec2 = property(_crd && DissolveEffect === void 0 ? (_reportPossibleCrUseOfDissolveEffect({
        ...
        attackEventCallBack() {
          ...
          console.log("攻击帧事件回调");
          let ani = this.target.node.getChildByName("TX_sangshigongji");
          ani.active = true;
          ani.getComponent(Animation).play();
        }

        attacHitkEventCallBack() {
          const skeletalAnim = this.target.characterSkeletalAnimation;
        ...
        toMove() {
          ...
          if (this.findWay && this.findWay.length > 0) {
            const tweenObj = tween(this.node).to(this.speedTime, {
        ...
        lookAtTarget(targetPos) {
          ...
          const parent = (_this$node$parent = this.node.parent) == null ? void 0 : _this$node$parent.parent;
        ...
        moveToTarget(deltaTime, targetPos) {
          ...
          const distance = this.tempDir.length(); // console.log("=================>", distance, "====================>", this.stopDistance)
...
//# sourceMappingURL=50d0ae860817932dd89b00bd75e6f53cc96120d7.js.map