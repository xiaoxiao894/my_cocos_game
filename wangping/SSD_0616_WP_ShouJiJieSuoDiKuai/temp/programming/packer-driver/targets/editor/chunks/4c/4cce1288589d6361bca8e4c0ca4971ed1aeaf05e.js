  ...
  return {
    ...
    execute: function () {
      ...
      _export("touchEvent", touchEvent = (_dec = ccclass('touchEvent'), _dec2 = property(Camera), _dec(_class = (_class2 = class touchEvent extends Component {
        ...
        onTouchStart(event) {
          const currentTime = Date.now(); // 检查距离上次点击是否超过设定的间隔时间
          ...
          if (PhysicsSystem.instance.raycastClosest(ray, mask, maxDistance, queryTrigger)) {
            ...
            if (result.collider) {
              ...
              if (nodeName.startsWith("UI_famuzhiyin")) {
                ...
                let enemyTree = result.collider.node.parent.getComponent(_crd && EnemyTree === void 0 ? (_reportPossibleCrUseOfEnemyTree({
                  error: Error()
                }), EnemyTree) : EnemyTree);
...
//# sourceMappingURL=4cce1288589d6361bca8e4c0ca4971ed1aeaf05e.js.map