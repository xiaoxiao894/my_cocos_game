    ...
    execute: function () {
      ...
      _export("UIWarnManager", UIWarnManager = (_dec = ccclass('UIWarnManager'), _dec(_class = class UIWarnManager extends Component {
        ...
        playWarnFadeAnimation() {
          ...
          const opacity = ((_this$node = this.node) == null ? void 0 : _this$node.getComponent(UIOpacity)) || ((_this$node2 = this.node) == null ? void 0 : _this$node2.addComponent(UIOpacity)); // 停止之前的动画（如果有）
...
//# sourceMappingURL=10f1133fb772d3503a05f4db541175866a6f6aa0.js.map