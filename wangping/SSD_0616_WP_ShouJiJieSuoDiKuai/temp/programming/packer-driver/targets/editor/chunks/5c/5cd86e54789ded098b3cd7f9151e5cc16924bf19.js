  ...
  return {
    ...
    execute: function () {
      ...
      _export("CornHandOver", CornHandOver = (_dec = ccclass('CornHandOver'), _dec(_class = class CornHandOver extends (_crd && State === void 0 ? (_reportPossibleCrUseOfState({
        ...
        handOver() {
          // 获取交付位置节点
          let handOverPosNode = this.entity.getCornHandOverNode();
          ...
          let woodParent = this.entity.node.getChildByName("backpack1");
          ...
          const controlPoint = new Vec3((woodNode.worldPosition.x + handOverPos.x) / 2, (woodNode.worldPosition.y + handOverPos.y) / 2 + LIFT_HEIGHT, (woodNode.worldPosition.z + handOverPos.z) / 2); // 执行贝塞尔曲线动画
...
//# sourceMappingURL=5cd86e54789ded098b3cd7f9151e5cc16924bf19.js.map