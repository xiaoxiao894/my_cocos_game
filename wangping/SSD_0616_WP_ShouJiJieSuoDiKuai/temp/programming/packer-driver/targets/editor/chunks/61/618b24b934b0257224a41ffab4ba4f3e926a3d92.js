    ...
    execute: function () {
      ...
      _export("CutTreeState", CutTreeState = (_dec = ccclass('CutTreeState'), _dec(_class = class CutTreeState extends (_crd && State === void 0 ? (_reportPossibleCrUseOfState({
        ...
        onEnter(callback) {
          ...
          const enemyTree = this.entity.target;
        ...
        performAttack(enemyTree, character) {
          ...
          let tt = this.entity.characterSkeletalAnimation.getState("kanshu").wrapMode; // 添加单次监听器
...
//# sourceMappingURL=618b24b934b0257224a41ffab4ba4f3e926a3d92.js.map