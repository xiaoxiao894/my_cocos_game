    ...
    execute: function () {
      ...
      _export("GroundEffct", GroundEffct = (_dec = ccclass('GroundEffct'), _dec2 = property(Camera), _dec3 = property(Animation), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Animation), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(Node), _dec13 = property(Node), _dec14 = property(Animation), _dec15 = property(Node), _dec16 = property(Node), _dec17 = property(Node), _dec18 = property(Node), _dec19 = property(Node), _dec20 = property(Node), _dec21 = property(Node), _dec22 = property(Node), _dec23 = property(Node), _dec24 = property(Node), _dec25 = property(Node), _dec26 = property(Node), _dec27 = property(Node), _dec28 = property(Node), _dec29 = property(Node), _dec30 = property(Node), _dec31 = property({
        ...
        passAnimation1() {
          ...
          var targetPosition = new Vec3(8, 22, 32.7);
          var targetPosition1 = new Vec3(14.8, 19, 32.3);
          var targetPosition2 = new Vec3(0, 21.8, 32.3);
        ...
        passAnimation11() {
          var targetPosition = new Vec3(8, 22, 32.7);
          var targetPosition1 = new Vec3(13.8, 19, 43.1);
          tween(this.mainCamera.node).to(0.8, {
            position: targetPosition
          }).call(() => {
            tween(this.mainCamera.node).to(0.8, {
        ...
        passAnimation2() {
          ...
          var targetPosition = new Vec3(13.927, 33.377, 16.287);
          var targetPosition1 = new Vec3(31.3, 47.4, 58.5);
          var targetPosition2 = new Vec3(40.64, 47.385, 58.454);
          var targetPosition3 = new Vec3(15, 15, 37.1);
        ...
        passAnimation21() {
          var targetPosition2 = new Vec3(28, 28.4, 42.8);
        ...
        passAnimation3() {
          ...
          var targetPosition = this.cameraPosition1; // new Vec3(20, 100, 75);
          ...
          var tree = this.tree3.getChildByName("DK-102");
          tree.children.forEach(child => {
            if (child.getChildByName("UI_famuzhiyin")) {
              var n = child.getChildByName("UI_famuzhiyin"); // 获取当前节点的缩放值

              var currentScale = n.scale.clone(); // 计算放大 1.2 倍后的缩放值

              var targetScale = currentScale.multiplyScalar(1.53);
              tween(n).to(1.7, {
                scale: targetScale
              }).start();
            }
        ...
        showAllTreeClick() {
          for (var i = 0; i < 3; i++) {
            var tree = this.tree3.getChildByName("DK-10" + (i + 1));
            tree.children.forEach(child => {
        ...
        upgradeTreeHouseAnimation(callback) {
          ...
          var house1 = this.treeLandHouse.getChildByName("shengjiqian");
          var house2 = this.treeLandHouse.getChildByName("shengjihou");
          var particle = this.treeLandHouse.getChildByName("TX_shengjiLZ");
          house1.active = false;
          house2.active = true;
          particle.active = true;
          var treeLandHouseAnim = this.treeLandHouse.getComponent(Animation);
          var particleAnim = particle.getComponent(Animation); // const treeLandHouseAnim = this.treeLandHouse.getComponent(Animation);
          // 检查特定动画状态（假设动画剪辑名为"upgrade_anim"）

          var animState = treeLandHouseAnim.getState("shengji_fangzi");
        ...
        upgradeEnemyHouseAnimation(callback) {
          ...
          var house1 = this.enemyLandHouse.getChildByName("shengjiqian");
          var house2 = this.enemyLandHouse.getChildByName("shengjihou");
          var particle = this.enemyLandHouse.getChildByName("TX_shengjiLZ");
          house1.active = false;
          house2.active = true;
          particle.active = true;
          var treeLandHouseAnim = this.enemyLandHouse.getComponent(Animation);
          var particleAnim = particle.getComponent(Animation); // 创建两个 Promise，分别在动画完成时 resolve
        ...
        upgradeAnimation() {
          var anim = this.upgradeNode.getComponent(Animation);
          ...
          if ((_crd && Global === void 0 ? (_reportPossibleCrUseOfGlobal({
            ...
            var animState = anim.getState('SJZY');
...
//# sourceMappingURL=bc504589d2a0cbb6fbeee3d4a1c7c241e9e8f8fc.js.map