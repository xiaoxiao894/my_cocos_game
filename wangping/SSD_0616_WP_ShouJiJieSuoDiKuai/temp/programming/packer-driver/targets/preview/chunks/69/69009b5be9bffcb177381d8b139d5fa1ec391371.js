  ...
  return {
    ...
    execute: function () {
      ...
      _export("BubbleFead", BubbleFead = (_dec = ccclass('BubbleFead'), _dec2 = property({
        ...
        Show() {
          this.imageFead.forEach(element => {
            var originalScale = element.scale.clone();
            var shrunkenScale = originalScale.clone().multiplyScalar(1.2);
            var uiOpacity = element.getComponent(UIOpacity); // uiOpacity.opacity = 0;
        ...
        Show1(num) {
          ...
          this.imageFead.forEach(element => {
            var originalScale = new Vec3(0.01, 0.01, 0.01);
            var shrunkenScale = originalScale.clone().multiplyScalar(1.2);
            var uiOpacity = element.getComponent(UIOpacity); // uiOpacity.opacity = 0;
...
//# sourceMappingURL=69009b5be9bffcb177381d8b139d5fa1ec391371.js.map