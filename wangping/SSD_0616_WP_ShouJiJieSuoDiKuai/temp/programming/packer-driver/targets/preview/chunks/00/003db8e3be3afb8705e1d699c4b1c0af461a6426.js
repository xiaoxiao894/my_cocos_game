    ...
    execute: function () {
      ...
      _export("HandOver", HandOver = (_dec = ccclass('HandOver'), _dec(_class = class HandOver extends (_crd && State === void 0 ? (_reportPossibleCrUseOfState({
        ...
        handOver() {
          ...
          var handOverPosNode = this.entity.getHandOverPosNode();
          ...
          var woodParent = this.entity.node.getChildByName("backpack");
          ...
          var controlPoint = new Vec3((woodNode.position.x + handOverPos.x) / 2, (woodNode.position.y + handOverPos.y) / 2 + LIFT_HEIGHT, (woodNode.position.z + handOverPos.z) / 2); // 执行贝塞尔曲线动画
...
//# sourceMappingURL=003db8e3be3afb8705e1d699c4b1c0af461a6426.js.map