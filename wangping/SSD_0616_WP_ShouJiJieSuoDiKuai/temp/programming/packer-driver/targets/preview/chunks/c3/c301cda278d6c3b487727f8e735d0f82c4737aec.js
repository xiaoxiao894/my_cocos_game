      ...
      _export("TreeController", TreeController = (_dec = ccclass('TreeController'), _dec(_class = (_class2 = class TreeController {
        ...
        initAllTree(parentNode) {
          ...
          for (var i = 0; i < this.parentNode.children.length; i++) {
            ...
            var enemyTree = this.parentNode.children[i];
            var enemyTreeComp = enemyTree.getComponent(_crd && EnemyTree === void 0 ? (_reportPossibleCrUseOfEnemyTree({
              error: Error()
            }), EnemyTree) : EnemyTree);
        ...
        netxTree() {
          ...
          var enemyTreeComp = this.enemyTreeList[this.curCutTreeIndex];
          enemyTreeComp.setFindState(true);
          enemyTreeComp.showArrowTarger();
          this.curCutTreeIndex += 1;
        }
...
//# sourceMappingURL=c301cda278d6c3b487727f8e735d0f82c4737aec.js.map