import { resources, Asset, AssetManager, SpriteFrame, Prefab, AudioClip, Texture2D } from 'cc';
...
export class ResourceManager {
     ...
     */
    public loadPrefab(path: string, onProgress?: (completedCount: number, totalCount: number, item: AssetManager.RequestItem) => void): Promise<Prefab> {
        return this.load<Prefab>(path, Prefab, onProgress);
    }
    //使用示例
    // 加载场景时显示进度
