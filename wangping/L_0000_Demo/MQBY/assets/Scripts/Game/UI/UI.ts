...
export class UI extends Component {
    ...
    @property({ type: Label, displayName: '棉签数量' })
    private virusLabel: Label = null!;
    @property({ type: Label, displayName: '金币数量' })
    private goldLabel: Label = null!;
    @property({ type: Label, displayName: '爆炸水果数量' })
    private explosionFruitLabel: Label = null!;
    ...
    protected onLoad(): void {
        ...
        this.virusLabel.string = "0";
        this.goldLabel.string = "0";
        this.explosionFruitLabel.string = "0";
    }
    ...
    private onUpdateHeroItemCount(data: { type: ObjectType, count: number }): void {
        ...
        } else if (data.type === ObjectType.DropItemSwab) {
            this.virusLabel.string = data.count.toString();
        } else if (data.type === ObjectType.DropItemExplosionFruit) {
            this.explosionFruitLabel.string = data.count.toString();
        }
    }
