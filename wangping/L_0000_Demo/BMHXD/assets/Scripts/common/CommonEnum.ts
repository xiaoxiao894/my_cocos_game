...
export enum CommonEvent{
    ...
    /** 隐藏提示事件 */
    HideTips = "hide-tips",
    SpiderEggAttacked = "SpiderEggAttacked",
    CameraAniEnd = "BossGoBack",
    CoinCountChanged = "CoinCountChanged",
}
...
export enum BuildingType {
    ...
    FireGun = 'FireGun',
    /** 武器究极升级类型 */
    WeaponUltimateUpgrade = 'WeaponUltimateUpgrade',
    /** 地块扩展类型 */
