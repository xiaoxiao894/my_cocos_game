...
langMgr.registerMultiLanguageData({
    ...
    "guide_waitStart": {
        "zh_cn": "回到庇护所",
        "en": "Back to the shelter",
        "fr": "Retourner au refuge",
        "zh_ft": "回到庇護所",
        "ja": "庇護所に戻る",
        "ko": "보호소로 돌아가기"
    },
    ...
    "guide_goToChuShi": {
        "zh_cn": "将玉米做成爆米花",
        "en": "Make corn kernels into popcorn",
        "fr": "Faire des noyaux de maïs en popcorn",
        "zh_ft": "將玉米做成爆米花",
        "ja": "マイズの粒を爆米花にする",
        "ko": "옥수수 씨앗을 팝콘으로 만드세요"
    },
    "guide_goToTouFang": {
        "zh_cn": "喂饱虫子",
        "en": "Feed the worm",
        "fr": "Donner du maïs au ver",
        "zh_ft": "餵飽蟲子",
        "ja": "虫にマイズを食べさせる",
        "ko": "벌레에게 옥수수 씨앗을 주기"
    },
    ...
    "guide_unlockFireGun": {
        "zh_cn": "解锁喷火枪",
        "en": "Unlock the fire gun",
        "fr": "Débloquer le fusil à feu",
        "zh_ft": "解鎖噴火槍",
        "ja": "噴火槍を解鎖する",
        "ko": "불 총을 해금하세요"
    },
    "guide_goKillEnemys": {
        "zh_cn": "清理所有蜘蛛卵！",
        "en": "Clear all spider eggs!",
        "fr": "Nettoyer tous les oeufs d'araignées !",
        "zh_ft": "清理所有蜘蛛卵！",
        "ja": "すべての蜘蛛卵を消し去る！",
        "ko": "모든 거미 알을 제거하세요!"
    }
