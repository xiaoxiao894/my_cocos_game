...
import { MoveAttackState } from "../State/MoveAttackState";
...
export default class Entity extends Component {
    ...
    protected onLoad(): void {
        ...
        // 初始化状态机
         ...
         this.stateMachine.addState(CharacterStateType.MoveAttack, new MoveAttackState(this));
         this.stateMachine.addState(CharacterStateType.Attack, new AttackState(this));
        // 监听事件
