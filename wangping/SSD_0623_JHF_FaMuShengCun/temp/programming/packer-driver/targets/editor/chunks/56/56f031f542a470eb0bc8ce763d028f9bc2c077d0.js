      ...
      _export("BoardConManager", BoardConManager = (_dec = ccclass('BoardConManager'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(SkeletalAnimation), _dec(_class = (_class2 = class BoardConManager extends Component {
        ...
        boardManagerInit() {
          this._boardPool = new Pool(() => {
            const boardPrefab = (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
              error: Error()
        ...
        _handleArrive(board, dm) {
          ...
          tween(board).to(0.05, {
            ...
            const denLen = (_this$denominatorLabe = (_this$denominatorLabe2 = this.denominatorLabel) == null || (_this$denominatorLabe2 = _this$denominatorLabe2.string) == null ? void 0 : _this$denominatorLabe2.length) != null ? _this$denominatorLabe : 0;
            ...
            const fireAni = (_this$fireNode = this.fireNode) == null ? void 0 : _this$fireNode.getComponent(Animation);
        ...
        update(dt) {
          ...
          const dm = (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
            error: Error()
          }), DataManager) : DataManager).Instance;
          if (!dm.curReduceTemplateTimeArr) return; // 缓存经常用到的量

          const level = dm.conveyorLevel || 1;
          const speedStep = this._speed * dt * level; // === 更新木桩（木板）位置，从后往前安全移除 ===
          ...
          if (this._curBoardCount > 0) {
            ...
            const reduceTime = (_dm$curReduceTemplate = dm.curReduceTemplateTimeArr[dm.curReduceTemplateTimeIndex]) != null ? _dm$curReduceTemplate : 2;
            ...
            if (this._elapsedTime >= reduceTime) {
              ...
              const denominatorNum = Number((_this$denominatorLabe3 = (_this$denominatorLabe4 = this.denominatorLabel) == null ? void 0 : _this$denominatorLabe4.string) != null ? _this$denominatorLabe3 : "0");
        ...
        denominatorUpgradeAni(minNum, maxNum, interval = 0.05) {
