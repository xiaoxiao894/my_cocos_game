    ...
    execute: function () {
      ...
      _export("UIWarnManager", UIWarnManager = (_dec = ccclass('UIWarnManager'), _dec(_class = class UIWarnManager extends Component {
        ...
        playWarnFadeAnimation() {
          ...
          var opacity = ((_this$node = this.node) == null ? void 0 : _this$node.getComponent(UIOpacity)) || ((_this$node2 = this.node) == null ? void 0 : _this$node2.addComponent(UIOpacity));
          opacity.opacity = 0;
...
//# sourceMappingURL=3b20bdc572bb012aab4c4d216084e433ddcab146.js.map