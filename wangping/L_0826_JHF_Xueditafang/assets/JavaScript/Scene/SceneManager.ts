import { _decorator, Component, Prefab, Node, director, find, math, Material, Pool, instantiate, MeshRenderer, primitives, Vec3, utils, Color, BoxCollider } from 'cc';
import { CollisionEntityEnum, EntityTypeEnum, GamePlayNameEnum, PathEnum, PrefabPathEnum } from '../Enum/Index';
...
export class SceneManager extends Component {
    ...
    updateGuidanceData() {
        ...
        console.log(DataManager.Instance.guideTargetList);
    }
    ...
    addRvoObstacle() {
        ...
        DataManager.Instance.obstacleArr.push(...outSide1.children, ...outSide2.children, ...outSide3.children, ...outSide4.children);
        ...
        // for (let i = 0; i < DataManager.Instance.obstacleArr.length; i++) {
        //     const prefab = instantiate(this.boxNode);

        //     prefab.setWorldPosition(DataManager.Instance.obstacleArr[i].getWorldPosition());
    ...
    collectGuardrails(scene) {
        ...
        //     prefab.setWorldPosition(DataManager.Instance.guardrailArr[i].node.getWorldPosition());
        //     prefab.setParent(this.node)
        // }
    }
