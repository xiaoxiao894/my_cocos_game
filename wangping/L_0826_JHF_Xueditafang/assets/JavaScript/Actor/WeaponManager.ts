...
export class WeaponManager extends Component {
    ...
    weaponPos = [
        new Vec3(-1.744, 2.91, -1.809),
        new Vec3(-3.022, 2.91, -1.809),
        new Vec3(-4.309, 2.91, -1.809)
    ];
    ...
    private spawnAndAnimateWeapon(prefab: Prefab, end: Vec3, duration: number, slotIndex: number) {
        ...
        weapon.setPosition(new Vec3(-3.16, -2.235, -0.274));
    ...
    automaticallyTransmitAni() {
        ...
        lastWeapon.setScale(0.7, 0.7, 0.7)
