      ...
      _export("ArrowManager", ArrowManager = (_dec = ccclass('ArrowManager'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = class ArrowManager extends Component {
        ...
        update(deltaTime) {
          ...
          if ((_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
            ...
            var nearestMonster = this.getNearMonster((_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
              error: Error()
            ...
            if ((_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
              ...
              var targetData = (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
                error: Error()
        ...
        createArrowPathTo(targetPos) {
          ...
          var player = (_Instance$player = (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
            error: Error()
        ...
        getNearMonster(player) {
          ...
          for (var i = 0; i < monsterParent.children.length; i++) {
            var monster = monsterParent.children[i];
            if (!monster || !monster.isValid) continue;
            var monsterPos = monster.worldPosition;
            var dx = monsterPos.x - playerPos.x;
            var dz = monsterPos.z - playerPos.z;
