    ...
    execute: function () {
      ...
      _export("JackManager", JackManager = (_dec = ccclass('JackManager'), _dec(_class = class JackManager extends Component {
        fireAtTarget(name) {
          ...
          var playerManager = this.node.parent.parent.getComponent(_crd && PlayerManager === void 0 ? (_reportPossibleCrUseOfPlayerManager({
            error: Error()
...
//# sourceMappingURL=e0b661dce1a7c14a49db25468ab451eb594393ec.js.map