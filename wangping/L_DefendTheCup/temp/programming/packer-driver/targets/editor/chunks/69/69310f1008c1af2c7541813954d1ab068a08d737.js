    ...
    execute: function () {
      ...
      _export("CardConManager", CardConManager = (_dec = ccclass('CardConManager'), _dec2 = property(Node), _dec3 = property(Prefab), _dec(_class = (_class2 = class CardConManager extends Component {
        ...
        createCards(otherNode) {
          ...
          const results = (_crd && MathUtil === void 0 ? (_reportPossibleCrUseOfMathUtil({
            error: Error()
          ...
          results.forEach((cardData, index) => {
            this.scheduleOnce(() => {
              ...
              const cardPrefab = (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
                error: Error()
        ...
        addPartner(name) {
          ...
          const partnerManager = partner.getComponent(_crd && PartnerManager === void 0 ? (_reportPossibleCrUseOfPartnerManager({
            error: Error()
          ...
          if (this.isUnlockDeliveryAreas6) {
            ...
            const deliveryAreas6 = this.otherNode.parent.getChildByName((_crd && CollisionEntityEnum === void 0 ? (_reportPossibleCrUseOfCollisionEntityEnum({
              error: Error()
            }), CollisionEntityEnum) : CollisionEntityEnum).DeliveryAreas6);

            if (deliveryAreas6) {
              const itemAreaManager = deliveryAreas6.getComponent(_crd && ItemAreaManager === void 0 ? (_reportPossibleCrUseOfItemAreaManager({
                error: Error()
