    ...
    execute: function () {
      ...
      _export("UIPartnerEnergyBarManager", UIPartnerEnergyBarManager = (_dec = ccclass('UIPartnerEnergyBarManager'), _dec(_class = class UIPartnerEnergyBarManager extends Component {
        ...
        update(deltaTime) {
          ...
          const partnerManager = this.node.parent.getComponent(_crd && PartnerManager === void 0 ? (_reportPossibleCrUseOfPartnerManager({
            error: Error()
          }), PartnerManager) : PartnerManager);
          const anim = partnerParent == null ? void 0 : partnerParent.getComponent(Animation);
          const skillState = anim == null ? void 0 : anim.getState("skillALL"); // skillALL 正在播放中，等待完成
        ...
        playSkillAllAndRelease(partnerManager, anim) {
          ...
          const skillState = anim == null ? void 0 : anim.getState("skillALL");
          ...
          if (anim && skillState) {
            ...
            anim.once(Animation.EventType.FINISHED, () => {
              ...
              const dirState = anim == null ? void 0 : anim.getState(clipName); // console.log("=========> 播放方向动画", clipName);
