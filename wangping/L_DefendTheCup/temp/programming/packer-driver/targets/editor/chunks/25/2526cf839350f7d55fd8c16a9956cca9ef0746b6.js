  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", Util = class Util {
        ...
        static getDateStr(time, format = 1) {
        ...
        static generatorCallBack(len, callBack, ...params) {
          function* gen() {
            for (let i = 0; i < len; i++) {
...
//# sourceMappingURL=2526cf839350f7d55fd8c16a9956cca9ef0746b6.js.map