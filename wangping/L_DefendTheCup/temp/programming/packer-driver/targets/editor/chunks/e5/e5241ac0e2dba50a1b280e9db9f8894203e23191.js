System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Label, Node, tween, UIOpacity, Vec3, DataManager, super_html_playable, LanguageManager, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, GameEndManager;
    ...
    execute: function () {
      ...
      _export("GameEndManager", GameEndManager = (_dec = ccclass('GameEndManager'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec(_class = (_class2 = class GameEndManager extends Component {
        ...
        start() {
          ...
          const downloadLabel = (_this$download = this.download) == null || (_this$download = _this$download.getChildByName("Label")) == null ? void 0 : _this$download.getComponent(Label);
        ...
        init() {
          ...
          (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
            error: Error()
          }), DataManager) : DataManager).Instance.soundManager.WinSoundPlay();
          ...
          tween(this.win).delay(0.1).to(0.3, {
            scale: new Vec3(1.1, 1.1, 1.1)
          }).to(0.3, {
            scale: new Vec3(1, 1, 1)
          }).call(() => {
...
//# sourceMappingURL=e5241ac0e2dba50a1b280e9db9f8894203e23191.js.map