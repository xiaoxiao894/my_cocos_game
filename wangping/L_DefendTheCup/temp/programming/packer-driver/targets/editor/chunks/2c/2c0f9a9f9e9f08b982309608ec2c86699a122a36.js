      ...
      _export("MinionManager", MinionManager = (_dec = ccclass('MinionManager'), _dec2 = property(SkeletalAnimation), _dec3 = property(Prefab), _dec(_class = (_class2 = class MinionManager extends Component {
        ...
        changState(state) {
          ...
          if (state == (_crd && MinionStateEnum === void 0 ? (_reportPossibleCrUseOfMinionStateEnum({
            ...
            const idleClip = this.skeletalAnimation.clips.find(clip => clip.name === (_crd && MinionStateEnum === void 0 ? (_reportPossibleCrUseOfMinionStateEnum({
              error: Error()
        ...
        chaseTarget(dt) {
          ...
          if (!this.isMoveMinion && this._noMoveSeachTime > this._noMoveSearchInterval || !this._targetMonster || !this._targetMonster.isValid || this._seachTime >= this._seachInterval) {
            ...
            for (const monster of monsterParent.children) {
              ...
              let monsterItem = monster.getComponent(_crd && MonsterItem === void 0 ? (_reportPossibleCrUseOfMonsterItem({
                error: Error()
        ...
        smoothLookAt(targetPos, dt, rotateSpeed = 10) {
          ...
          const currentY = this.node.eulerAngles.y; // 归一化差值到 [-180, 180]
        ...
        attackTarget() {
          ...
          const monsterItem = this._targetMonster.getComponent(_crd && MonsterItem === void 0 ? (_reportPossibleCrUseOfMonsterItem({
            error: Error()
          }), MonsterItem) : MonsterItem);
          ...
          try {
            ...
            const targetPos = target.getWorldPosition(); // 使用 lookAt 让子弹 -Z 轴 朝向目标
