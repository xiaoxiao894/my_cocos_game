      ...
      _export("SceneManager", SceneManager = (_dec = ccclass('SceneManager'), _dec2 = property(Node), _dec3 = property(Material), _dec4 = property(Material), _dec(_class = (_class2 = class SceneManager extends Component {
        ...
        async start() {
          (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
            error: Error()
          }), DataManager) : DataManager).Instance.sceneManager = this;
        ...
        addRvoObstacle() {
          let tempList = [];
          const scene1Physics = find((_crd && PathEnum === void 0 ? (_reportPossibleCrUseOfPathEnum({
            error: Error()
          ...
          const outSide1 = find((_crd && PathEnum === void 0 ? (_reportPossibleCrUseOfPathEnum({
            error: Error()
          }), PathEnum) : PathEnum).OutSide1);
          const outSide2 = find((_crd && PathEnum === void 0 ? (_reportPossibleCrUseOfPathEnum({
            error: Error()
          }), PathEnum) : PathEnum).OutSide2);
          const outSide3 = find((_crd && PathEnum === void 0 ? (_reportPossibleCrUseOfPathEnum({
            error: Error()
          }), PathEnum) : PathEnum).OutSide3);
          const outSide4 = find((_crd && PathEnum === void 0 ? (_reportPossibleCrUseOfPathEnum({
            error: Error()
          ...
          for (let i = 0; i < (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
            error: Error()
          }), DataManager) : DataManager).Instance.obstacleArr.length; i++) {
            const node = (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
              error: Error()
            }), DataManager) : DataManager).Instance.obstacleArr[i];
            (_crd && RVOObstacles === void 0 ? (_reportPossibleCrUseOfRVOObstacles({
              error: Error()
            }), RVOObstacles) : RVOObstacles).addOneObstacle(node);
          }
        ...
        initAddScene1DoorFun() {
          const scene1 = find((_crd && PathEnum === void 0 ? (_reportPossibleCrUseOfPathEnum({
            error: Error()
        ...
        addSceneDoorFun(path) {
          const index = (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
            error: Error()
        ...
        isNodeInsideDoorArea(node) {
          const doors = (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
            error: Error()
          ...
          if (this._frames++ > 10) {
            ...
            (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
              ...
              if (guardrail.attackingMonsterCount <= 0) {
                let bloodNode = guardrail.node.getChildByName((_crd && EntityTypeEnum === void 0 ? (_reportPossibleCrUseOfEntityTypeEnum({
                  error: Error()
