...
export class UIJoyStick extends Component {
    ...
    onTouchStart(event: EventTouch) {
        ...
        EventManager.inst.emit(EventName.TouchScreenStart);
    }
    ...
    onTouchEnd(event: EventTouch) {
        ...
        EventManager.inst.emit(EventName.TouchScreenEnd);
    }
    ...
    private noTouch():boolean{
        if(DataManager.Instance.isGameEnd){
            return true;
        }
        if(DataManager.Instance.cameraMain){
            return !DataManager.Instance.cameraMain.isNomalState();
        }
        return false;
    }
